...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $locations = ['Астана', 'Алматы', 'Шымкент', 'Актобе', 'Атырау', 'Караганда', 'Кокшетау', 'Костанай', 'Кызылорда', 'Павлодар', 'Петропавловск', 'Семей', 'Талдыкорган', 'Тараз', 'Туркестан', 'Уральск', 'Усть-Каменогорск', 'Шымкент'];
