            ...
            @if ( !empty(request('sale')) || !empty(request('location')) || !empty(request('type')) || !empty(request('price')) || !empty(request('bedrooms')) )
                <h3 class="text-sm mt-1 font-normal">
                    ...
                    @if (request('price') == 100000)
                        {{__('within')}} 0 {{ __('Tk') }} - 1,00,000 {{ __('Tk') }} {{__('Price')}} {{__('Range')}}
                    @elseif (request('price') == 200000)
                        {{__('within')}} 1,00,000 {{ __('Tk') }} - 2,00,000 {{ __('Tk') }} {{__('Price')}} {{__('Range')}}
                    @elseif (request('price') == 300000)
                        {{__('within')}} 2,00,000 {{ __('Tk') }} - 3,00,000 {{ __('Tk') }} {{__('Price')}} {{__('Range')}}
                    @elseif (request('price') == 400000)
                        {{__('within')}} 3,00,000 {{ __('Tk') }} - 4,00,000 {{ __('Tk') }} {{__('Price')}} {{__('Range')}}
                    @elseif (request('price') == 500000)
                       {{__('and More than')}} 5,00,000 {{ __('ft') }} {{__('Price')}}
                    @endif
                    {{__('from')}}
                ...
                <h4 class="text-sm font-normal"><span class="font-bold">{{ $latest_properties->total() }}</span> {{__('Property Found')}}</h4>
            @endif
