                    ...
                    <form action="{{route('properties.store')}}" method="post" class="p-6 bg-white border-b border-gray-200" enctype="multipart/form-data">
                        ...
                        <div class="flex -mx-4 mb-6">
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="name">{{__('Title')}} <span class="required-text">*</span></label>
                        ...
                        <div class="mb-6">
                            <label class="civanoglu-label" for="featured_image">{{__("Featured Image")}} <span class="required-text">*</span></label>
                        ...
                        <div class="mb-6">
                            <label class="civanoglu-label" for="gallery_images">{{__('Gallery')}} {{__('images')}} <span class="required-text">*</span><small class="ml-2 lowercase">(multiple image supported)</small></label>
                        ...
                        <div class="flex -mx-4 mb-6">
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="location_id">{{__('Location')}} <span class="required-text">*</span></label>
                            ...
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="price">{{__('Price')}} <span class="required-text">*</span></label>
                            ...
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="sale">{{__('For')}} <span class="required-text">*</span></label>
                                <select class="civanoglu-input" name="sale" id="sale" required>
                                    <option value="">{{__('Select')}} {{__('type')}}</option>
                                    <option {{old('sale')=='2' ? 'selected="selected"' : '' }} value="2">{{__('Rent')}}</option>
                                    <option {{old('sale')=='1' ? 'selected="selected"' : '' }} value="1">{{__('Sale')}}</option>
                            ...
                            <div class="flex-1 px-4">
                                ...
                                <select class="civanoglu-input" name="type" id="type" required>
                                    ...
                                    <option {{old('type')=='3' ? 'selected="selected"' : '' }} value="3">{{__('Land')}}</option>
                                    <option {{old('type')=='1' ? 'selected="selected"' : '' }} value="1">{{__('Apartment')}}</option>
                                    <option {{old('type')=='2' ? 'selected="selected"' : '' }} value="2">{{__('Villa')}}</option>
                        ...
                        <div class="flex -mx-4 mb-6">
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="drawing_rooms">{{__('Drawing rooms')}}</label>
                            ...
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="gross_sqm">{{__('Gross square meeter')}}</label>
                        ...
                        <div class="flex -mx-4 mb-6">
                            <div class="flex-1 px-4">
                                <label class="civanoglu-label" for="description">{{__('Description')}} <span class="required-text">*</span></label>
