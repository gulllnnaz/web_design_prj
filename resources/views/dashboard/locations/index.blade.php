                ...
                <div class="">
                    <table class="w-full table-auto mb-4">
                        <thead class="bg-green-500 text-white">
                            <tr>
                                <th class="border px-4 py-4">{{__('No')}}</th>
                                ...
                                <tr class="bg-green-300 hover:bg-red-500 hover:text-white duration-50">
                                    ...
                                    <td class="border px-4 py-2">
                                        <div class="flex items-center justify-center">
                                            <a href="{{ route('location.edit', $location->id) }}" class="mx-1 hover:bg-black hover:text-white duration-200 leading-none bg-blue-700 text-white px-3 py-2 text-sm rounded-md">{{__('edit')}}</a>
